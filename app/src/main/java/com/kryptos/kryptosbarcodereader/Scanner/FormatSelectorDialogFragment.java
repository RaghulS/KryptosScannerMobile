...
public class FormatSelectorDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String[] formats = new String[MyScannerView.ALL_FORMATS.size()];
        boolean[] checkedIndices = new boolean[MyScannerView.ALL_FORMATS.size()];
        int i = 0;
        for(BarcodeFormat format : MyScannerView.ALL_FORMATS) {
