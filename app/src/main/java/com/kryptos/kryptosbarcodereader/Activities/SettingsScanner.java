...
public class SettingsScanner extends ActionBarActivity implements
	...
	public void handleResult(Result rawResult) {
		try {
			...
			Intent i = new Intent(SettingsScanner.this, SettingsActivity.class);
	...
	public void closeMessageDialog() {
		...
		Intent aIntent = new Intent(SettingsScanner.this, HomeActivity.class);
